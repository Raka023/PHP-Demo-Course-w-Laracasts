...
<main class="bg-gradient-to-b from-black via-zinc-950 to-zinc-900 min-h-screen flex items-center justify-center">
    <div class="w-full max-w-2xl mx-auto px-4 py-12">
        <div class="rounded-lg border border-zinc-800 bg-zinc-950 p-8 shadow-lg">
            <h2 class="text-2xl font-semibold text-zinc-100 mb-12 text-center">Login to an Account</h2>
            <form action="/login" method="POST" class="space-y-6" novalidate>
                ...
                <div>
                    ...
                    <input id="password" name="password" type="password" placeholder="Password" class="block w-full rounded-md border border-zinc-800 bg-zinc-900/50 text-zinc-100 p-3 focus:border-zinc-500 focus:ring-2 focus:ring-zinc-500" />
                    ...
                    <div class="md:col-start-2">
                        <label class="inline-flex items-center gap-2 cursor-pointer select-none text-sm text-zinc-400">
                            <span class="relative flex items-center">
                                <input id="toggle-password" type="checkbox" class="peer sr-only" />
                ...
                <div class="flex items-center justify-between mt-6">
                    <a href="/register" class="text-sm text-zinc-400 hover:text-zinc-100 transition-colors">Don't have an account?</a>
