        ...
        <div class="rounded-lg border border-zinc-800 bg-zinc-950 p-8 relative">
            ...
            <form method="POST" class="space-y-6">
                <div>
                    ...
                    <textarea id="body" name="body" placeholder="Here's an idea for a note..." rows="6" class="block w-full rounded-md border border-zinc-800 bg-zinc-900/50 text-zinc-100 p-4 focus:border-zinc-500 focus:ring-2 focus:ring-zinc-500 resize-none"><?= htmlspecialchars($_POST['body'] ?? '') ?></textarea>
                </div>
